...
class ProductsController extends Controller
{
    ...
    {
        // return $product->with('category:id,name','store:id,name')->first();// with method dosnt work with object and it return query builder which donst convert to json by laravel
